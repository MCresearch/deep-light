...
bool FFT::fft_initialize(int mm, int n, FFT &fft)
{
	...
	outfile1111.open("./test/dl_fft_in_kk0.dat", ios::app);
    outfile1121.open("./test/dl_fft_in_kj0.dat", ios::app);
    ...
    ofstream outfile111;
    ofstream outfile112;
	outfile111.open("./test/dl_fft_in_kk.dat", ios::app);
    outfile112.open("./test/dl_fft_in_kj.dat", ios::app);
    ...
    //***********************************************
	ofstream outfile113;
	outfile113.open("./test/dl_fft_in_km0.dat", ios::app);
    ...
    ofstream outfile114;
    ofstream outfile115;
	outfile114.open("./test/dl_fft_in_wr.dat", ios::app);
    outfile115.open("./test/dl_fft_in_wi.dat", ios::app);
    ...
    ofstream outfile117;
    ofstream outfile118;
	outfile116.open("./test/dl_fft_in_km_0.dat", ios::app);
    outfile117.open("./test/dl_fft_in_km_1.dat", ios::app);
    outfile118.open("./test/dl_fft_in_km_2.dat", ios::app);
...
void FFT::my_fft2d(FFT &fft, int n9, double** &xr, double** &xi, double dx, int kt)
{
    ...
    ofstream outfile123;
    ofstream outfile124;
	outfile121.open("./test/dl_fft_in_temp_cr1.dat", ios::app);
    outfile122.open("./test/dl_fft_in_temp_ci1.dat", ios::app);
    outfile123.open("./test/dl_fft_in_temp_xr1.dat", ios::app);
    outfile124.open("./test/dl_fft_in_temp_xi1.dat", ios::app);
